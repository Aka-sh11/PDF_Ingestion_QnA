...
def get_conversational_chain():
    prompt_template = """
                        ...
                        that are relevant to the question, if the answer is not in 
                        the provided context just say, "answer is not available in 
                        the context", don't provide any wrong information.
